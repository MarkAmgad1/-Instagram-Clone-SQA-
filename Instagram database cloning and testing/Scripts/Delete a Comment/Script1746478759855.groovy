...
// 1. امسح الكومنت
String deleteCommentSQL = "DELETE FROM comments WHERE user_id = 1 AND post_id = 1 AND comment_text = 'Great photo!'"
Statement statement = connection.createStatement()
statement.executeUpdate(deleteCommentSQL)

// 2. تحقق أن الكومنت اتحذف
...
if (!resultSet.next()) {
	...
	println("❌ Comment deletion failed!")
}
...
// إضافة نتيجة جديدة
data << ["name": "Delete a comment", "status": "Passed"]
